...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["AD"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["AM"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["Dnn"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["D01"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["D02"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["D03"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["G01"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["G02"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["G03"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["G75"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["LP"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["LM"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["LR"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["LS"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["region_statement"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["AB_statement"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["SR_statement"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["TF"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["TA"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["TO"]},
    {"name": "start$ebnf$1$subexpression$1", "symbols": ["TD"]},
