...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "region_statement", "symbols": ["G36", "region_statement$ebnf$1", "G37"], "postprocess":  ([g36, [contour], g37]) => ({
    ...
    {"name": "contour", "symbols": ["D02", "contour$ebnf$1"], "postprocess": ([d02, rest]) => [d02].concat(rest.flatMap(a => a))},
    {"name": "G36$string$1", "symbols": [{"literal":"G"}, {"literal":"3"}, {"literal":"6"}], "postprocess": (d) => d.join('')},
    {"name": "G36", "symbols": ["G36$string$1", {"literal":"*"}], "postprocess": ([command_code]) => ({ command_code })},
    {"name": "G37$string$1", "symbols": [{"literal":"G"}, {"literal":"3"}, {"literal":"7"}], "postprocess": (d) => d.join('')},
    {"name": "G37", "symbols": ["G37$string$1", {"literal":"*"}], "postprocess": ([command_code]) => ({ command_code })},
